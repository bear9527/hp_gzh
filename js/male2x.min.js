...
$(document).ready(function() {
    $('#menbck_base').stop().hide().animate({
        'opacity': '0'
    }, 1000);
    $('.mengo_bck').stop().on('click', function() {
        $('#menfrt_base').stop().hide().animate({
            'opacity': '0'
        }, 1000);
        $('#menbck_base').stop().show().animate({
            'opacity': '1'
        }, 1000)
    });
    $('.mengo_frt').stop().on('click', function() {
        $('#menbck_base').stop().hide().animate({
            'opacity': '0'
        }, 1000);
        $('#menfrt_base').stop().show().animate({
            'opacity': '1'
        }, 1000)
    })
});
...
var frt_config = {
    ...
    'frt_29': {
        'hover': '<b><u>LEG</u></b><br><span style="color: #ff1a75;">*Link each part to any webpage*</span>',
        'enable': !0,
        'url': 'javascript:void(0);',
        'target': 'same_window',
        'upColor': '#FF0000',
